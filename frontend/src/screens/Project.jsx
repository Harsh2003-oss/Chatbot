        ...
        <>
            ...
            <main className='h-screen w-screen flex'>
                ...
                <section className='flex relative flex-col h-full min-w-96 '>
                    ...
                    {/* ✅ FIXED: Conversation area now takes full remaining height */}
                    <div className="conversation-area flex flex-grow flex-col bg-slate-300 min-h-0">
                        {/* ✅ FIXED: Message box with proper flex and overflow */}
                        <div className="message-box p-4 flex-1 flex flex-col gap-2 overflow-y-auto scrollbar-hide">
                            {messages.length === 0 ? (
                        ...
                        {/* ✅ FIXED: Input field - fixed height at bottom */}
                        <div className="input-field w-full flex flex-shrink-0 bg-white border-t border-gray-200">
                            <input
                                value={message}
                                onChange={(e) => setMessage(e.target.value)}
                                onKeyPress={(e) => e.key === 'Enter' && send()}
                                className='p-3 flex-grow px-4 border-none outline-none bg-transparent'
                                type="text" 
                            ...
                            <button 
                                ...
                                className='px-6 bg-slate-950 text-white hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'>
                    ...
                    <div className={`sidePanel w-full h-full bg-slate-50 flex flex-col gap-2 absolute top-0 left-0 transition-transform duration-300 ease-in-out z-10 ${isSidePanelOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                        ...
                        <div className="users flex flex-col gap-2 p-2 overflow-y-auto flex-1">
